...
\item Social media tools such as Facebook and Slack are good at sharing knowledge to your team.
\end{itemize}
...
Social media tools could be an effective way to bridge the gap between active and passive forms of communication for game developers, 

To help developers stay productive, having agreed active and passive forms of communication, such as video conferencing (Active) E-Mail (passive) \cite{joshi2013}. This means that developers can organise a time to do a video conference for every sprint and then use passive forms of communication for
